            ...
            <div className="allvideo-sectionn">
                <div className="video-sorting">
                    <button
                        className={
                            videosort === "Latest"
                                ? `latest-video ${theme ? "" : "btn-light-mode"} active${theme ? "" : "-light"
                                }`
                    ...
                    <button
                        className={
                            videosort === "Popular"
                                ? `Popular-video ${theme ? "" : "btn-light-mode"} active${theme ? "" : "-light"
                                }`
                    ...
                    <button
                        className={
                            videosort === "Oldest"
                                ? `Oldest-video ${theme ? "" : "btn-light-mode"} active${theme ? "" : "-light"
                                }`
                ...
                >
                    {myVideos.length > 0 &&
                        myVideos.map((element, index) => {
                            return (
                                <div
                                    className={`${element.visibility === "Private"
                                            ? "not-thiss"
